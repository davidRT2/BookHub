    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
            <div class="flex flex-col justify-center">
                ...
                <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Empowering Your Reading
                    Experience with Book Hub.</p>
                <a href="#"
                ...
                <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                    ...
                    <p class="mt-4 text-center text-gray-500 dark:text-gray-400">
                        Already have an account? <a href="/login"
                            class="text-blue-600 dark:text-blue-500 hover:underline">Back to Login</a>
                    </p>
                </div>
            </div>
        </div>
